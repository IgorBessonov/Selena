...
// alert(form.tabl_cust.options[form.tabl_cust.selectedIndex].value);
/*			document.getElementById("B_Sub").innerHTML =
...
//			alert(document.getElementById("h_6003_floor").value);
...
// оформление заявки на ремонт.php?
		...
		c_str = "id_p="+form.h_id_Podjezd.value+"&fl="+form.h_fl.value+"&Notify="+form.noti.value+"&Bill_Dog="+Bill_Dog+
			"&Date_Plan="+form.Date_Plan.value+"&phone_Dop="+form.phone_Dop.value+
			"&TabNum="+form.TabNum.value+"&Cod_flat="+form.h_Cod_flat.value;//+"&Date_in="+form.n_date.value
