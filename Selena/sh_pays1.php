...
<tr align="center">
	<td width="25" bgcolor="<?php $cfg['BgcolorOne'] = "#E5E5E5"; $cfg['BgcolorTwo'] = "#D5D5D5";	$bgcolor = $cfg['BgcolorOne'];
					   echo $bgcolor; ?>"> №</br>п/п</td>
...
$result = mysql_query("select * from v_actions where `Bill_Dog`=$Bill_Dog");// and DATE_FORMAT(InputDate,'%Y') = '".$iY."' ORDER BY InputDate DESC, `Date_start` DESC v_actions.Date_start DESC,
    ...
    <tr>
        ...
        <td width="140" align="center" bgcolor="<?php echo $bgcolor; ?>">
            <? if(!in_array($row["id_ActionType"],array(2,7,8,9,10))) {// не интернет операция
                ...
                $D_en = strtotime($row["Date_end"]); $m_e = $m[date("n", $D_en)];
