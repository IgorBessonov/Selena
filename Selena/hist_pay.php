...
<tr><td colspan=8><div id="<? echo $Bill_Dog.($iY-1)?>">
    <input type="button" onclick="ch_param('hist_pay', '<? echo "tn={$tn}&Bill_Dog={$Bill_Dog}&ab_s={$ab_s}&ab_n={$ab_n}&iY=",$iY-1,"', '",$Bill_Dog.($iY-1)?>');" value="<? echo $iY-1?>" />
</div></td></tr>
